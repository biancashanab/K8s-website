...
?>
	...
	?>
		...
		@cats [data-v-cat] input|id = <?php echo 'm' . $category['taxonomy_item_id'];?>
		@cats [data-v-cat] input|addNewAttribute = <?php if ($category['active']) echo 'checked';?>
		@cats [data-v-cat] label|for = <?php echo 'm' . $category['taxonomy_item_id'];?>

		@cats [data-v-cat]|addClass = <?php if ($category['active']) echo 'active';?>
		
		@cats [data-v-cat]|append = <?php 
